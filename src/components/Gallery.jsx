...
import VideoModal from './UI/VideoPlayer';
import '../css/Gallery.css'
import '../css/VideoPlayer.css';


export default function Gallery  (probs)  {
  ...
  return (
    <div className="gallery">
        ...
        <VideoModal videoUrl={probs?.videoUrl}/>
        </div>
        <img src={selectedImage} alt="Zoomed Image"  className="img-fluid Show-image"/>
        ...
        {images.map((image) => (
          <div className=" mt-2" key={image.id}>
            <img
              src={image.src}
              alt={image.alt}
              style={{height:'7rem',width:'7rem',border:'1px orange solid'}}
              className="img-fluid"
