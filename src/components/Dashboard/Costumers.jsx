      ...
      >
        ...
        >
          <label className="radio">
            ...
            />
            <span className="name" style={{color:'orange'}}>Users</span>
          </label>
          <label className="radio">
            <input
              type="radio"
              ...
              onChange={handleRadioChange}
            />
            <span className="name" style={{color:'orange'}}>Users History</span>
          </label>
        </div>
      </div>
                      ...
                      <div className="card-body p-0">
                        ...
                        >
                          <table className="table table-striped mb-0">
                            <thead style={{ backgroundColor: "#000000",color:'orange' }}>
                              <tr>
                                <th scope="col">ID</th>
